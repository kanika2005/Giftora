        ...
        <div className="flex gap-4 overflow-x-auto pb-4">
          {categories.map(cat => (
            <button
              ...
              className={`px-6 py-2 rounded-full font-medium whitespace-nowrap transition ${selectedCategory === cat
                  ? 'text-white'
              ...
              <div className="relative card overflow-hidden transition">
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="text-lg font-bold" style={{ color: 'var(--igp-pink)' }}>
                      {p.price != null ? `₹${Number(p.price).toFixed(0)}` : 'Price unavailable'}
                    </div>
                  </div>
                </div>
              </div>
